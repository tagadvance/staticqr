...
const STOP_SIGN =
  'M7.7 1h8.6L23 7.7v8.6L16.3 23H7.7L1 16.3V7.7zM12 6.5v7m0 3.2v.3';
...
function renderReadback(text) {
  ...
  if (decoded === text) {
    ...
    readback.append(
      element('h2', null, copy.passTitle),
      element('p', null, copy.passBody),
    );
    return;
  }
  ...
  readback.append(
    element('h2', null, copy.failTitle),
    element('p', null, copy.failBody),
  );
  if (decoded !== null) {
